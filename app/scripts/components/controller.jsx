...
var Controller = React.createClass({
  ...
  render: function(){
    ...
    var pods = _.map(cats, function(category, index){
      var button = ( <button onClick={this.doRotation.bind(this, index)} key={index}>{category[0].cat_rendered[0].cat_name}</button> );
      buttons.push(button);
